 ...
 * generated in the at.tfr.securefs.client.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _DeleteResponse_QNAME = new QName("http://securefs.tfr.at/", "deleteResponse");
    ...
    private final static QName _Delete_QNAME = new QName("http://securefs.tfr.at/", "delete");
    private final static QName _Write_QNAME = new QName("http://securefs.tfr.at/", "write");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: at.tfr.securefs.client.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://securefs.tfr.at/", name = "deleteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://securefs.tfr.at/", name = "delete")
