...
public final class UiShare$___Marshaller_93258254b8161fd518c8465d83e0e5cd326214aed3cc18837322ff2aa855e308 extends org.infinispan.protostream.annotations.impl.GeneratedMarshallerBase implements org.infinispan.protostream.ProtobufTagMarshaller<at.tfr.securefs.key.UiShare> {

   @Override
   public Class<at.tfr.securefs.key.UiShare> getJavaClass() { return at.tfr.securefs.key.UiShare.class; }
   
   @Override
   public String getTypeName() { return "UiShare"; }
   
   @Override
   public at.tfr.securefs.key.UiShare read(org.infinispan.protostream.ProtobufTagMarshaller.ReadContext $1) throws java.io.IOException {
      final org.infinispan.protostream.TagReader $in = $1.getReader();
      final at.tfr.securefs.key.UiShare o = new at.tfr.securefs.key.UiShare();
      long __bits$0 = 0;
      boolean done = false;
      while (!done) {
   ...
   @Override
   public void write(org.infinispan.protostream.ProtobufTagMarshaller.WriteContext $1, at.tfr.securefs.key.UiShare $2) throws java.io.IOException {
      final org.infinispan.protostream.TagWriter $out = $1.getWriter();
      final at.tfr.securefs.key.UiShare o = (at.tfr.securefs.key.UiShare) $2;
      {
         final int __v$1 = o.index;
         $out.writeInt32(1, __v$1);
      }
      {
         final java.lang.String __v$2 = o.share;
         if (__v$2 != null) $out.writeString(2, __v$2);
      }
      {
         final java.lang.String __v$3 = o.realShare;
