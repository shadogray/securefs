...
public class ClientMessageHandlerImpl implements MessageHandler {
	...
	public ClientMessageHandlerImpl(Configuration configuration, ObjectMapper objectMapper, MessageSender messageSender) {
